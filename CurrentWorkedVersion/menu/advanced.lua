...
function advanced:init()
	...
	self.mastervolbtny = -92
	
	-- Music Vol Button Y & X
	self.musicvolbtny = -42
	
	-- SFX Vol Button Y & X
	self.sfxvolbtny = 8
	
	-- Default Button Y & X
	self.defaultbtny = 108
	
	-- Changelog Button Y & X
	self.changelogbtny = 158
...
function advanced:draw()
	...
	love.graphics.rectangle("line", (love.graphics.getWidth()/2 - 604/2), (love.graphics.getHeight()/2 - 664/2), 604, 664 )
	love.graphics.setColor(0, 0, 0, 100)
	love.graphics.rectangle("fill", (love.graphics.getWidth()/2 - 600/2), (love.graphics.getHeight()/2 - 660/2), 600, 660 )
	love.graphics.setColor(255, 255, 255)
	------ SHAPES ------
	...
	love.graphics.setColor(255, 255, 255)
	love.graphics.print('ADVANCED', (love.graphics.getWidth()/2 - start.font9:getWidth("ADVANCED")/2), (love.graphics.getHeight()/2 - start.font9:getHeight("ADVANCED")/2) - 220)
	...
	love.graphics.setColor(255, 255, 255)
	love.graphics.print('RESOLUTION:', love.graphics.getWidth()/2 - start.font2:getWidth( "DISPLAY FPS:" )/2 - 120, (love.graphics.getHeight()/2 - start.font2:getHeight( "RESOLUTION:" )/2) + self.resolutionbtny)
	--love.graphics.setColor(160, 47, 0, 255)
	...
	love.graphics.setColor(255, 255, 255)
	love.graphics.print('MASTER VOL:', love.graphics.getWidth()/2 - start.font2:getWidth( "DISPLAY FPS:" )/2 - 120, (love.graphics.getHeight()/2 - start.font2:getHeight( "MASTER VOL:" )/2) + self.mastervolbtny, 0)
	love.graphics.setColor(255, 255, 255)
	love.graphics.print('MUSIC VOL:', love.graphics.getWidth()/2 - start.font2:getWidth( "DISPLAY FPS:" )/2 - 120, (love.graphics.getHeight()/2 - start.font2:getHeight( "MUSIC VOL:" )/2) + self.musicvolbtny)
	love.graphics.setColor(255, 255, 255)
	love.graphics.print('SFX VOL:', love.graphics.getWidth()/2 - start.font2:getWidth( "DISPLAY FPS:" )/2 - 120, (love.graphics.getHeight()/2 - start.font2:getHeight( "SFX VOL:" )/2) + self.sfxvolbtny)
	love.graphics.setColor(255, 255, 255)
	love.graphics.print('RESET DEFAULT', love.graphics.getWidth()/2 - start.font2:getWidth( "DISPLAY FPS:" )/2 - 120, (love.graphics.getHeight()/2 - start.font2:getHeight( "RESET DEFAULT" )/2) + self.defaultbtny)
	love.graphics.setColor(255, 255, 255)
	love.graphics.print('CHANGELOG', love.graphics.getWidth()/2 - start.font2:getWidth( "DISPLAY FPS:" )/2 - 120, (love.graphics.getHeight()/2 - start.font2:getHeight( "CHANGELOG" )/2) + self.changelogbtny)
