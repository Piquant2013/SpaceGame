...
function game:draw()
	...
	if SetDeb == true then
		...
		love.graphics.print("Direction : "..tostring(game.Direction ), 715, love.graphics.getHeight( ) - 195)
		...
		-- Box 5
		love.graphics.print("PlayerRot: "..tostring(game.PlayerRot), 1010, love.graphics.getHeight( ) - 45)
		love.graphics.print("ShipDir: "..tostring(game.ShipDir), 1010, love.graphics.getHeight( ) - 30)
